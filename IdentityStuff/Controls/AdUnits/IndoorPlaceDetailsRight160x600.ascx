<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IndoorPlaceDetailsRight160x600.ascx.cs" Inherits="ClimbFind.Web.Mvc.Controls.AdUnits.IndoorPlaceDetailsRight160x600" %>
...
{  
   ...
   { %>
<% if (place.CountryID == (short)Nation.Canada)
   { %>
<%= CFAdControls.Ad("AreaMap.Right", 24)%>
<% }
   else if (place.CountryID == (short)Nation.England)
   { %> 
<%= CFAdControls.Ad("IndoorPlaceDetails.Right", 34)%>
<% }
   else
   { %>
