<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="PartnerAreaWidget.aspx.cs" Inherits="IdentityStuff.Views.PartnerCalls.PartnerAreaWidget" %>
...
<h1>People looking for partners around <%= areaTag.Name %></h1>
...
<% foreach (PartnerCall call in CallsForArea)
{ %>
      ...
      <table> 
            <tr>
                ...
                <td class="PostedTxT">                                          
                    Posted on <%= call.PostedDateTime.ToCFDateString() %>                   
            ...
            <tr>
                ...
                <td>
                    <p style="margin:0;padding:0">@ <%= call.PlacesClimbfindUrls %></p>
