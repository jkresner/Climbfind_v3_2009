...
var gVAM_PassThruKey = false; var gVAM_KFVal = null;function VAM_InitKey(pKO) 
{var vFld = VAM_GetById(pKO.CID); if (vFld) 
vFld.KO = pKO;} 
...
return;if (vFld.VAMSOC)return;vFld.VAMSOC = 1;if (vFld.value != null) 
{
if (!gVAM_SOC){gVAM_SOC = new Array;if (window.attachEvent)window.attachEvent("onunload", VAM_DisposeSOC);}
...
if (!pCFld || !pDEFld)return;if (!pDEFld.gocfld) 
{
if (!gVAM_GOC){gVAM_GOC = new Array;if (window.attachEvent)window.attachEvent("onunload", VAM_DisposeGOC);}
...
function VAM_DisposeGOC(){if (gVAM_GOC){for (var vI = 0; vI < gVAM_GOC.length; vI++){var vF = gVAM_GOC[vI];vF.HFoc = null;vF.gocfld = null;if (vF.gocDE)for (var vJ = 0; vJ < vF.gocDE.length; vJ++)vF.gocDE[vJ] = null;vF.gocDE = null;vF.soconchange = null;} 
}gVAM_GOC = null;} 
...
function VAM_VWBInit(pMode, pList) 
{window.gVAM_VWBMd = pMode; for (var vI = 0; vI < pList.length; vI++){var vO = pList[vI]; var vF = VAM_GetById(vO.CID);if (vF.VWB != null) 
